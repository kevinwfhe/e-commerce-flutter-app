...
@MaterialAutoRouter(
  ...
  routes: <AutoRoute>[
    AutoRoute(path: '/', page: ClientMainPage, initial: true, children: [
      AutoRoute(path: '', name: 'ProductRoute', page: ProductsScreen),
      AutoRoute(path: 'cart', name: 'CartRoute', page: CartScreen),
      AutoRoute(
          path: 'order',
          name: 'OrderRouter',
          page: EmptyRouterPage,
          children: [
            AutoRoute(path: '', page: OrderScreen),
            AutoRoute(path: ':orderId', page: OrderDetailScreen),
          ]),
    ]),
    AutoRoute(
        path: '/checkout',
    ...
    AutoRoute(path: '/cart', name: 'StandAloneCartRoute', page: CartScreen),
    AutoRoute(
        path: '/login', name: 'LoginRoute', page: AuthentificationBuyerScreen),
    AutoRoute(
        path: '/admin',
        name: 'AdminRouter',
        page: EmptyRouterPage,
        children: [
          AutoRoute(path: '', name: 'AdminMainRoute', page: AdminMainScreen),
          AutoRoute(
              path: 'login',
